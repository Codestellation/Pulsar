...
namespace Codestellation.Pulsar.Tests.Cron
{
    ...
    public class TimeFieldTests
    {
        ...
        {
            var field = TimeField.ParseSeconds("42");
        ...
        {
            var field = TimeField.ParseSeconds("5,42,12");
        ...
        {
            var field = TimeField.ParseSeconds("*");
        ...
        {
            var field = TimeField.ParseSeconds("1-3,20-22,42");
        ...
        {
            var field = TimeField.ParseSeconds("0-3,20/5");
